 ...
 * 
 */
@WebServiceClient(name = "MyWebServiceService", targetNamespace = "http://webpackage/", wsdlLocation = "http://localhost:8081/soap?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MYWEBSERVICESERVICE_QNAME = new QName("http://webpackage/", "MyWebServiceService");
    ...
    public MyWebService getMyWebServicePort() {
        return super.getPort(new QName("http://webpackage/", "MyWebServicePort"), MyWebService.class);
    }
    ...
    public MyWebService getMyWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webpackage/", "MyWebServicePort"), MyWebService.class, features);
    }
